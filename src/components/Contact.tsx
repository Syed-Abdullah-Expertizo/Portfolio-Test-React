...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormStatus({ message: 'Processing...', isError: false });
  ...
  const contactInfo = [
    {
      ...
      title: "Location",
      details: "123 Tech Street, New York, NY 10001, USA"
    },
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg shadow-md p-8">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="w-10 h-10 rounded-full bg-gray-800 text-white flex items-center justify-center hover:bg-black transition-colors">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              {formStatus && (
                <div className={`mb-6 p-4 rounded-md ${formStatus.isError ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
                  {formStatus.message}
                </div>
              )}
